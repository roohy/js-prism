...
var arch = new prims.core.architecture("clientServer");
arch.scaffold = scf;
...
var clientRequestPort = new prism.core.port("Client request Port"  ,prism.prismConstants.REQUEST);
clientComp.addCompPort(clientRequestPort);


var serverReplyPort = new prism.core.port("Server Reply Port" , )